...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-1">
            <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#addModal">Agregar</a>
        </div>
    </div>
    ...
    <table class="table table-bordered" id="studentTable">
        ...
        @foreach ($students as $student)
            <tr id="{{ $student->id }}">
                ...
                <td>
		     <a data-id="{{ $student->id }}" class="btn btn-success btnEdit">Editar</a>
		     <a data-id="{{ $student->id }}" class="btn btn-warning btnDelete">Borrar</button>
                </td>
            </tr>
        @endforeach
		</tbody>
	  ...
	  <div class="modal-body">
		<form id="addStudent" name="addStudent" action="{{ route('student.store') }}" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="txtLastName" placeholder="Ingrese el apellido" name="txtLastName">
			</div>
			<div class="form-group">
